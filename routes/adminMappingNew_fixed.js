...
// Helper function to get coordinates from customer
                ...
                try {
                    ...
                    for (const device of genieacsDevices) {
                        try {
                            ...
                            // If needed, can be added to customers table or use alternative
                    ...
                    // FIXED: Ensure customers are available before use
