...
// Helper function to get parameter value from GenieACS device
function getParameterValue(device, parameterPath) {
    try {
        ...
        try {
            ...
            for (const device of genieacsDevices) {
                try {
                    ...
                    // 1. Try to find by PPPoE username
                    ...
                    if (pppoeUsername && pppoeUsername.includes && pppoeUsername.includes('santo')) {
                        ...
                        // If customer found, add device with coordinates
                        if (customerData) {
